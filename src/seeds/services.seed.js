...
export async function seedServices() {
    await db
        .insert(services)
        .values([
            { name: 'Personal Shopper (fashion)', slug: 'fashion', service_type: 'lifestyle', iconEmoji: '👗' },
            { name: 'Personal Shopper (lifestyle)', slug: 'lifestyle', service_type: 'lifestyle', iconEmoji: '✨' },
            { name: 'Personal Shopper (home)', slug: 'home', service_type: 'lifestyle', iconEmoji: '🏠' },
            { name: 'Personal Shopper (jewellery)', slug: 'jewellery', service_type: 'lifestyle', iconEmoji: '💎' },
            { name: 'Personal Shopper (sneakers)', slug: 'sneakers', service_type: 'lifestyle', iconEmoji: '👟' },
            { name: 'Personal Shopper (beauty)', slug: 'beauty', service_type: 'lifestyle', iconEmoji: '💄' },
